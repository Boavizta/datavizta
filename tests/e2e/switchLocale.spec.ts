  ...
  test("browser locale fr should load french text", async ({ browser }) => {
    ...
    expect(
      await page.textContent(
        "#aggridwrapper-root > div > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-header.ag-focus-managed.ag-pivot-off > div.ag-header-viewport > div > div > div:nth-child(1) > div.ag-cell-label-container.ag-header-cell-sorted-none > div > span.ag-header-cell-text"
      )
    ).toBe("Fabricant");
