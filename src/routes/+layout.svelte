...
<div id="navbar" class="flex">
    <div class="flex title-font font-medium items-center">
        <a href="https://boavizta.org"
            ><img
                id="logo"
                style="height: 47px;width: 32px;"
                src="./logo_picto_color.png"
                alt="Boavizta"
            /></a
        >
    ...
    <nav id="burger_menu">
        <ul>
            <li>
                <a class="mr-5" href="/" on:click={showMenu}>{$_("nav.home")}</a
                >
            </li>
            <li>
                <a class="mr-5" href="/serversimpact" on:click={showMenu}
                    >{$_("nav.server-impact")}</a
                >
            </li>
            <li>
                <a class="mr-5" href="/cloudimpact" on:click={showMenu}
                    >{$_("nav.cloud-impact")}</a
                >
            </li>
            <li>
                <a class="mr-5" href="/terminalimpact" on:click={showMenu}
                    >{$_("nav.terminal-impact")}</a
                >
            </li>
            <li>
                <a class="mr-5" href="/iotimpact" on:click={showMenu}
                    >{$_("nav.iot-impact")}</a
                >
            </li>
            <li>
                <a
                    ...
                    on:click={showMenu}>{language}</a
                >
            </li>
            <li>
                <a class="mr-5" href="/manufacturerdata" on:click={showMenu}
                    >{$_("nav.manufacturer")}</a
                >
            </li>
        </ul>
    </nav>
    <input
        ...
        class="mb-5 ml-auto cursor-pointer"
        title="Choose language"
        on:click={updateLanguage}
        value={language_min}
        style="width: 20px;"
