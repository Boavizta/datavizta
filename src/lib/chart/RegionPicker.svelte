<script lang="ts">
    ...
    onMount(async () => {
        ...
        const regionParam = ParamParser.parseRegion(
...
<Select
    {items}
    bind:value
    containerClasses="border border-1 rounded-r px-2 py-2 w-full"
    {isDisabled}
/>
