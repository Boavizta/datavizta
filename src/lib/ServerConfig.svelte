...
<form>
    ...
    <div class="flex flex-row my-1 mx-2">
        <div class="basis-1/5 my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.quantity')}</label>
        ...
        <div class="basis-1/5  my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.Core_units')}</label>
        ...
        <div class="basis-1/5  my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.tdp')}</label>
        ...
        <div class="basis-2/5  my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.architecture')}</label>
    ...
    <div class="flex flex-row  my-1 mx-2">
        ...
        <div class="basis-1/4 h-full  my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.capacity')}</label>
    ...
    <div class="flex flex-row  my-1 mx-2">
        ...
        <div class="basis-2/4  my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.manufacturer')}</label>
            <div style="--borderRadius: 0.5em;">
    ...
    <div class="flex flex-row my-1 mx-2">
        <div class="basis-2/4 my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.localisation')}</label>
            <div style="--borderRadius: 0.5em;">
                <Select items={locaitems} on:select={region_select} value="Default"/>
            </div>
        </div>
        <div class="basis-2/4 my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.lifespan')}</label>
    ...
    <div class="flex flex-row my-1 mx-2">
        <div class="basis-2/4 my-1 mx-2">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.method')}</label>
            <div style="--borderRadius: 0.5em;">
                <Select items={methods} on:select={change_method} value="Electricity"/>
            </div>
        </div>
        <div class="basis-2/4 my-1 mx-2" id="conso">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.avrg_elec')}</label>
        ...
        <div class="basis-2/4 my-1 mx-2" id="model" style="display: none">
            <label class="block mb-2 text-sm font-medium text-gray-900">{$_('server-impact.load')}</label>
