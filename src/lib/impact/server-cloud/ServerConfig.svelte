<script lang="ts">
    ...
    <div id="server-config.cpu" class="hidden md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-1">
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.Core_units')}</label>
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.tdp')}</label>
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.architecture')}</label>
    ...
    <p on:click={() => Utils.toggleElement("server-config.ram")} class="sm:block md:hidden"><a class="text-xl" href="javascript:void(0);" >> </a><span class="text-xl  my-1">RAM </span><span class="text-md"> ({serverConfig.config.ram[0].units} x {serverConfig.config.ram[0].capacity}GB - {$_('manufacturer')} : {serverConfig.config.ram[0].manufacturer})</span></p>
    <p class="hidden md:block"><span class="text-xl  my-1">RAM </span></p>
    <div id="server-config.ram" class="hidden md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-1">
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.quantity')}</label>
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.capacity')}</label>
  ...
  <div id="server-config.ssd" class="hidden md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-1">
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.manufacturer')}</label>
            <div style="--borderRadius: 0.5em;">
                <Select items={ssdmanufitems} on:select={ssd_manuf_select} value="Micron"/>
            </div>
        </div>
    </div>
  <p on:click={() => Utils.toggleElement("server-config.others")} class="sm:block md:hidden"><a class="text-xl" href="javascript:void(0);" >> </a><span class="text-xl  my-1">{$_('server-config.others')} </span><span class="text-md"> ({serverConfig.config.disk[1].units} HDD - {serverConfig.model.type} - {serverConfig.config.power_supply.units} {$_('server-config.psu')})</span></p>
  <p class="hidden md:block"><span class="text-xl  my-1">{$_('server-config.others')}</span></p>
  <div id="server-config.others" class="hidden md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-1">
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.hdd-quantity')}</label>
        ...
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.case_type')}</label>
            <div style="--borderRadius: 0.5em;">
                <Select items={casetypes} on:select={casetype_select} value="Rack"/>
            </div>
        </div>
        <div class="relative min-w-[100px] w-full mb-2 group">
            <label class="block text-sm font-medium text-gray-900">{$_('server-config.psu_number')}</label>
